				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
							<li><a href="index.html">Pavly</a></li>
							<li><a href="dashboard-sale.html">Kirolos</a></li>
							<li><a href="dashboard-crm.html">Mr Remon</a></li>
							<li><a href="dashboard-analytics.html">Mr Essam</a></li>
							<li><a href="dashboard-project.html">Mr Waseem</a></li>
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
